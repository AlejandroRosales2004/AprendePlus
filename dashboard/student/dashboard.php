...
<div class="student-panel">
  ...
  <main class="student-content">
    ...
    <div class="quick-links">
      <a href="courses.php" class="quick-link"><i class="fas fa-book"></i> Mis Cursos</a>
      <a href="progress.php" class="quick-link"><i class="fas fa-chart-line"></i> Mi Progreso</a>
      <a href="certificates.php" class="quick-link"><i class="fas fa-certificate"></i> Certificados</a>
    </div>
  </main>
</div>
<script>
